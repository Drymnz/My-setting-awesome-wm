-- CONFIGURACIÃ“N PRINCIPAL DE AWESOMEWM
-- documentacion (https://awesomewm.org/apidoc/index.html)
pcall(require, "luarocks.loader")

-- Biblioteca impresionante estÃ¡ndar del entorno
local gears = require("gears")
local awful = require("awful")
require("awful.autofocus")
-- Biblioteca de widgets y diseÃ±os
-- Biblioteca de widgets y diseÃ±os
...
-- Habilite el widget de ayuda de teclas rÃ¡pidas para VIM y otras aplicaciones
...
awful.layout.layouts =
    ...
    awful.layout.suit.floating, awful.layout.suit.fair, awful.layout.suit.tile.bottom}

-- ConfiguraciÃ³n del menÃº principal
myawesomemenu = {{"Atajos de teclado", function()
    hotkeys_popup.show_help(nil, awful.screen.focused())
end}, {"Manual", terminal .. " -e man awesome"}, {"Editar configuraciÃ³n", editor_cmd .. " " .. awesome.conffile},
                 {"Reiniciar", awesome.restart}, {"Salir", function()
    awesome.quit()
end}}
...
-- Cargar configuraciÃ³n de teclas
relizar_kyes(modkey, awful, hotkeys_popup, gears)
root.keys(globalkeys)

-- Reglas para clientes
awful.rules.rules = { -- Regla global para todos los clientes
{
    rule = {},
    properties = {
...
-- FunciÃ³n de seÃ±al para ejecutar cuando aparece un nuevo cliente.
...
client.connect_signal("property::minimized", function(c)
    if c.fullscreen and c.minimized then
        c.minimized = false
    end
end)

-- Aplicaciones de inicio automÃ¡tico
