...
#Listado Vulkan
pkg_vulkan_standar="vulkan-mesa-layers lib32-vulkan-mesa-layers vulkan-extra-layers vulkan-validation-layers lib32-vulkan-validation-layers vulkan-icd-loader lib32-vulkan-icd-loader vulkan-headers vulkan-tools vkd3d lib32-vkd3d "
...
#Listado Mesa
pkg_mesa_standar="mesa lib32-mesa glu lib32-glu lib32-glew glslang freeglut lib32-freeglut libepoxy lib32-libepoxy openra"

#Listado Otros
pkg_otros_standar="shaderc libretro-shaders-slang mesa-demos  lib32-mesa-demos libva-mesa-driver lib32-libva-mesa-driver lib32-mesa-vdpau nvtop"
...
pkg_otros_nvidia="nvidia-utils libvdpau libxnvctrl nvidia-prime nvidia-settings nccl lib32-libvdpau cuda cuda-tools cudnn nvidia-cg-toolkit python-cuda python-cuda-docs python-pycuda lib32-nvidia-cg-toolkit lib32-nvidia-utils"
